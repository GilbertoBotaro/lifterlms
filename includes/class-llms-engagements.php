...
class LLMS_Engagements {
	 ...
	 *
	 * @since Unknown
	 * @since [version] Update include path.
	 *
	 * @return void
	 */
	public function init() {

		require_once LLMS_PLUGIN_DIR . 'includes/class-llms-certificates.php';
		require_once LLMS_PLUGIN_DIR . 'includes/class-llms-achievements.php';
