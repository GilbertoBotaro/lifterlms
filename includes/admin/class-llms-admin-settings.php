...
class LLMS_Admin_Settings {
	 ...
	 *
	 * @since Unknown
	 * @since [version] Updated included file paths.
	 *
	 * @return LLMS_Settings_Page[] $settings An array of settings page objects.
	 */
	public static function get_settings_tabs() {
		...
		if ( empty( self::$settings ) ) {
			...
			$settings[] = LLMS_PLUGIN_DIR . 'includes/admin/settings/class-llms-settings-general.php';
			$settings[] = LLMS_PLUGIN_DIR . 'includes/admin/settings/class-llms-settings-general.php';
			$settings[] = LLMS_PLUGIN_DIR . 'includes/admin/settings/class-llms-settings-courses.php';
			$settings[] = LLMS_PLUGIN_DIR . 'includes/admin/settings/class-llms-settings-memberships.php';
			$settings[] = LLMS_PLUGIN_DIR . 'includes/admin/settings/class-llms-settings-accounts.php';
			$settings[] = LLMS_PLUGIN_DIR . 'includes/admin/settings/class-llms-settings-checkout.php';
			$settings[] = LLMS_PLUGIN_DIR . 'includes/admin/settings/class-llms-settings-engagements.php';
			$settings[] = LLMS_PLUGIN_DIR . 'includes/admin/settings/class-llms-settings-notifications.php';
			$settings[] = LLMS_PLUGIN_DIR . 'includes/admin/settings/class-llms-settings-integrations.php';

			/**
			 * Filters the settings pages found in the main LifterLMS Settings area on the admin panel.
			 *
			 * This filter can be used to register/deregister custom settings pages.
			 *
			 * @param LLMS_Settings_Page[] $settings An array of settings page objects.
			 */
